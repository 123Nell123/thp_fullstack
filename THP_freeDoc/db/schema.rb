...
ActiveRecord::Schema.define(version: 2022_02_10_184628) do

  create_table "ajout_specialities", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_ajout_specialities_on_doctor_id"
    t.index ["specialty_id"], name: "index_ajout_specialities_on_specialty_id"
  end
